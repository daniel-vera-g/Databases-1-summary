...
- [SQL](#sql)
  ...
  * [SQL-DDL Pt. 1](#sql-ddl-pt-1)
    + [Datenintegrität](#datenintegritat)
      - [Primärschlüsseln & versch. Werte](#primarschlusseln--versch-werte)
    + [Sequenzen](#sequenzen)
    + [Binärdaten](#binardaten)
  * [SQL-DML](#sql-dml)
    + [Einfügen in eine Tabelle](#einfugen-in-eine-tabelle)
    + [Löschen aus Tabelle](#loschen-aus-tabelle)
    + [Ganze Tabellen Löschen](#ganze-tabellen-loschen)
  ...
  * [SQL-DDL 2. Teil](#sql-ddl-2-teil)
    ...
    + [Trigger](#trigger)
    + [Datenintegrität durch Contraints](#datenintegritat-durch-contraints)
    ...
    + [Transaktionen](#transaktionen)
      ...
      - [Integritätssicherung](#integritatssicherung)
    + [NULL-Werte](#null-werte)
      - [Skalare Ausdrücke](#skalare-ausdrucke)
    + [Java-Sprachanbindungen(JDBC)](#java-sprachanbindungenjdbc)
      - [Zugriff auf Binäre Daten](#zugriff-auf-binare-daten)
